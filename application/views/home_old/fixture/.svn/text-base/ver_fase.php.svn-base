...
<div class="fixture_wrapper">
	<div class="fixture_table_titles">
        <div class="fixture_col_1 pos_col"><p>Equipos</p></div>
...
<div id="previous_date">
	<a href=""><img src="<?php echo base_url(); ?>img/fixture/previous_arrow.png"></a>
</div>
<div id="next_date">
	<a href=""><img src="<?php echo base_url(); ?>img/fixture/next_arrow.png"></a>
</div>
</div>
