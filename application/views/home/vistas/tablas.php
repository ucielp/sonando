		...
		<div class="container fondogris" id="contentarea">
			...
			<div class="row">
				...
				<div class="ajaxificando col-xs-12 col-sm-12 col-md-9 col-lg-9">
	...
	<script type="text/javascript">
		$('#leftmenu a.hoja').bind( "click", function(e) {
			e.preventDefault();
			$(".ajaxificando").html('<h1 class="ajax-loader"><img src="<?php echo base_url(); ?>images/ajax-loader.gif" /></h1>');
			var href = $(this).attr("href");
			$(".ajaxificando").load(href);
			$("body, html").animate({ 
					scrollTop: $( ".ajaxificando" ).offset().top - 115 
			}, 600);
		});
	</script>
  </body>
