	...
	<div class="col-xs-12 col-sm-12 col-md-8 col-lg-8">
		<div id="mainmenu" class="collapse navbar-collapse">
			<ul class="nav navbar-nav">
				<li class="<?=($this->uri->segment(1)==='predio')?'active':''?>"><a href="<?php echo base_url(); ?>predio">El Predio</a><img src="img/activemenu.png" class="activearrow"/></li>
				...
				<li class="<?=($this->uri->segment(1)==='notas')?'active':''?>"><a href="<?php echo base_url(); ?>notas">Notas</a><img src="img/activemenu.png" class="activearrow"/></li>
				<li class="<?=($this->uri->segment(1)==='contacto')?'active':''?>"><a href="<?php echo base_url(); ?>contacto">Contacto</a><img src="img/activemenu.png" class="activearrow"/></li>
