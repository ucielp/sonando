<div class="row" id="navlogo">
	...
	<div class="col-xs-10 col-sm-10 col-md-8 col-lg-8">
		<h1><a href="<?php echo base_url(); ?>"><img src="<?php echo base_url(); ?>img/logo.png" class="logo"/></a></h1>
	</div>
	<div class="col-xs-12 col-sm-12 col-md-2 col-lg-2 padtop20 xsnopadding">
		<div id="backlink" class="visible-xs-inline-block"><a href="<?php echo base_url(); ?>"><span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span> Inicio</a></div>
		<h2>0341 3882874</h2>
	</div>
</div>
